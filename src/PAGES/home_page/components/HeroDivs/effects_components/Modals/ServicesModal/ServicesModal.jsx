      ...
      >
        ...
        >
          <div className="modal_list">
            <ul>
              <li>Turn features into feelings, and scrolls into clicks.</li>
              <li>Make people feel your brand — not just see it.</li>
              <li>From "What is this?" to "I need this."</li>
              <li>Onboard, Educate, Impress</li>
              <li>Concepts Made Clickable</li>
            </ul>
          </div>
          <div className="deliverables">
        ...
        >
          <div className="modal_list">
            <ul>
              <li>Tell stories that move</li>
              <li>Lifestyle-Driven Stories</li>
              <li>Problem/Solution Hooks</li>
              <li>Emotional Triggers</li>
              <li>Short-Form Viral Content</li>
              <li>Onboarding Campaigns</li>
            </ul>
          </div>
          <div className="deliverables">
