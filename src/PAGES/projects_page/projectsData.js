...
import charmiyPlaystoreBanner from "../../ASSETS/VIDEOS/portfolio_videos/charmiy.png";
import charmiyPlaystore from "../../ASSETS/VIDEOS/portfolio_videos/charmiy.mp4";

import charmiy_marketing_pup_01Banner from "../../ASSETS/VIDEOS/portfolio_videos/charmiy_marketing_pup_01.png";
import charmiy_marketing_pup_01 from "../../ASSETS/VIDEOS/portfolio_videos/charmiy_marketing_pup_01.mp4";

import charmiy_marketing_movie_02Banner from "../../ASSETS/VIDEOS/portfolio_videos/charmiy_marketing_movie_02.png";
import charmiy_marketing_movie_02 from "../../ASSETS/VIDEOS/portfolio_videos/charmiy_marketing_movie_02.mp4";

import charmiy_marketing_videos_03Banner from "../../ASSETS/VIDEOS/portfolio_videos/charmiy_marketing_videos_03.png";
import charmiy_marketing_videos_03 from "../../ASSETS/VIDEOS/portfolio_videos/charmiy_marketing_videos_03.mp4";

import charmiy_howto_recordVideo_04Banner from "../../ASSETS/VIDEOS/portfolio_videos/charmiy_howto_recordVideo_04.png";
import charmiy_howto_recordVideo_04 from "../../ASSETS/VIDEOS/portfolio_videos/charmiy_howto_recordVideo_04.mp4";

import remotebanners from "../../ASSETS/VIDEOS/portfolio_videos/remote.png";
import remote from "../../ASSETS/VIDEOS/portfolio_videos/remote.mp4";

const projectsData = [
  // CHARMIY PLAYLIST index = 0
  {
    id: 0,
    name: "Charmiy",
    category: "Footage Explainer",
    tags: ["stock footage", "explainer", "marketing", "how to"],
    banner: charmiyPlaystoreBanner,
    video: charmiyPlaystore,
    summary:
      "Created a full suite of engaging and emotionally-driven videos for Charmiy, a next-gen social networking app powered by AI that connects real people through lifestyle-based video interactions. The project included the main Play Store promo video, feature walkthroughs, and relatable marketing content that captured the app’s unique value in real-life scenarios. Each video was designed to resonate with users on a personal level, highlighting Charmiy’s fresh take on connection beyond dating or friendship labels.",
    role: [
      "Concept planning",
      "Storyboarding",
      "Visual design",
  ...
  },
  {
    ...
    category: "Footage Explainer",
    tags: ["stock footage", "explainer", "marketing", "how to"],
    banner: charmiy_marketing_pup_01Banner,
    video: charmiy_marketing_pup_01,
    summary:
      "Created a full suite of engaging and emotionally-driven videos for Charmiy, a next-gen social networking app powered by AI that connects real people through lifestyle-based video interactions. The project included the main Play Store promo video, feature walkthroughs, and relatable marketing content that captured the app’s unique value in real-life scenarios. Each video was designed to resonate with users on a personal level, highlighting Charmiy’s fresh take on connection beyond dating or friendship labels.",
    role: [
      "Concept planning",
  ...
  },
  {
    ...
    category: "Footage Explainer",
    tags: ["stock footage", "explainer", "marketing", "how to"],
    banner: charmiy_howto_recordVideo_04Banner,
    video: charmiy_howto_recordVideo_04,
    summary:
      "Created a full suite of engaging and emotionally-driven videos for Charmiy, a next-gen social networking app powered by AI that connects real people through lifestyle-based video interactions. The project included the main Play Store promo video, feature walkthroughs, and relatable marketing content that captured the app’s unique value in real-life scenarios. Each video was designed to resonate with users on a personal level, highlighting Charmiy’s fresh take on connection beyond dating or friendship labels.",
    role: [
      "Concept planning",
  ...
  },
  {
    ...
    category: "Footage Explainer",
    tags: ["stock footage", "explainer", "marketing", "how to"],
    banner: charmiy_marketing_movie_02Banner,
    video: charmiy_marketing_movie_02,
    summary:
      "Created a full suite of engaging and emotionally-driven videos for Charmiy, a next-gen social networking app powered by AI that connects real people through lifestyle-based video interactions. The project included the main Play Store promo video, feature walkthroughs, and relatable marketing content that captured the app’s unique value in real-life scenarios. Each video was designed to resonate with users on a personal level, highlighting Charmiy’s fresh take on connection beyond dating or friendship labels.",
    role: [
      "Concept planning",
  ...
  },
  {
    ...
    category: "Footage Explainer",
    tags: ["stock footage", "explainer", "marketing", "how to"],
    banner: charmiy_marketing_videos_03Banner,
    video: charmiy_marketing_videos_03,
    summary:
      "Created a full suite of engaging and emotionally-driven videos for Charmiy, a next-gen social networking app powered by AI that connects real people through lifestyle-based video interactions. The project included the main Play Store promo video, feature walkthroughs, and relatable marketing content that captured the app’s unique value in real-life scenarios. Each video was designed to resonate with users on a personal level, highlighting Charmiy’s fresh take on connection beyond dating or friendship labels.",
    role: [
      "Concept planning",
  ...
  },
  {
    ...
    category: "Footage Explainer",
    name: "Remote",
    tags: ["stock footage", "explainer", "automation", "survey tool"],
    banner: remotebanners,
    video: remote,
    summary:
      "Created an animated explainer video for Remote, a global HR platform that enables companies to hire and manage international talent. The video aimed to clearly communicate how Remote simplifies cross-border employment through its Employer of Record (EOR) services, payroll solutions, and compliance tools. The final output was an engaging, visually appealing explainer designed to resonate with startups and global businesses alike.",
    role: [
      "Visual storytelling",
      "Scene planning",
      "Animation design",
  ...
  /// Pandadoc playlist index = 12
  {
    id: 12,
    name: "PandaDoc",
    category: "Animated Explainer",
    version: "PandaDoc Contracts",
    banner: pandadocbanners1,
    video: pandadoc1,
    summary:
  ...
  },
  {
    ...
    name: "PandaDoc",
    category: "Animated Explainer",
    version: "PandaDoc Quotes",
    banner: pandadocbanners2,
    video: pandadoc2,
    summary:
  ...
  },
  {
    ...
    name: "PandaDoc",
    category: "Animated Explainer",
    vesion: "PandaDoc e-Signatures",
    banner: pandadocbanners3,
    video: pandadoc3,
    summary:
      "My goal was to showcase PandaDoc's streamlined approach to contract management. So, I highlighted how PandaDoc simplifies the contract preparation process by offering an extensive template library and easy customization options. By focusing on PandaDoc's user-friendly interface, the videos emphasize how the platform transforms contract management into a straightforward, efficient experience.",
    role: [
  ...
  },
  {
    ...
    name: "PandaDoc",
    category: "Animated Explainer",
    version: "PandaDoc HR docs",
    banner: pandadocbanners4,
    video: pandadoc4,
    summary:
      "My goal was to showcase PandaDoc's streamlined approach to contract management. So, I highlighted how PandaDoc simplifies the contract preparation process by offering an extensive template library and easy customization options. By focusing on PandaDoc's user-friendly interface, the videos emphasize how the platform transforms contract management into a straightforward, efficient experience.",
    role: [
  ...
  },
  {
    ...
    name: "PandaDoc",
    category: "Animated Explainer",
    version: "PandaDoc Proposals",
    banner: pandadocbanners5,
    video: pandadoc5,
    summary:
      "My goal was to showcase PandaDoc's streamlined approach to contract management. So, I highlighted how PandaDoc simplifies the contract preparation process by offering an extensive template library and easy customization options. By focusing on PandaDoc's user-friendly interface, the videos emphasize how the platform transforms contract management into a straightforward, efficient experience.",
    role: [
